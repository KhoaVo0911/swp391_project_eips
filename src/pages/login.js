  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('https://i.chungta.vn/2020/02/17/1-1581877487_1200x0.jpg')`,
        }}
      >
        <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          ...
          />
          <h3 className="text-white text-4xl text-center font-bold mt-6 mx-12">
            {" "}
            EVENT IMMEDIATE PAYMENT CARD
          </h3>
        </div>
      </div>
      {/* Login form */}
      <div className="w-1/2 flex items-center justify-center">
        <form
          className=" z-10 px-10 py-5 h-[540px] w-[400px] bg-white rounded-lg"
