    ...
    dispatch(getShopByUsernameAsyncApi(userObject.username))
      .then((response) => {
        if (response.payload != undefined) {
          dispatch(getEventByShopAsyncApi(response.payload.id))
            .then((response) => {
              if (response.payload != undefined) {
              }
            })
                ...
                <div className="grid grid-cols-4">
                  ...
                  <div>
                    ...
                    <p className="d-flex flex-wrap mb-2">
                      ...
                      <span>
                        {eventByShop.beginDate &&
                          parseTimestamp(eventByShop.beginDate)}
                      </span>
                    </p>
                    <p className="d-flex flex-wrap mb-2">
                      ...
                      <span>
                        {eventByShop.beginDate &&
                          parseTimestamp(eventByShop.endDate)}
                      </span>
                    </p>
                    <p className="d-flex flex-wrap mb-2">
